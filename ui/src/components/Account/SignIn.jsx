...
export default function SignIn() {
  ...
  return (
    <div className="rounded-lg p-6 lg:p-16 w-full 2xl:w-[45rem]">
      ...
      <Link
        href={
          router?.query?.recruiter
            ? uiRoutes.forgotPassword + "?recruiter=true"
            : uiRoutes.forgotPassword
        }
        passHref
      >
      ...
      <button
        className="flex items-center justify-center bg-blue-500 dark:bg-blue-700 text-white w-full p-3 rounded-md text-sm md:text-base"
